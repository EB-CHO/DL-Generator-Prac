...
with st.expander("About this app :bulb:", expanded=False):
    st.markdown("#### This app uses the **Clarifai AI** engine to generate stories based on the input you provide using **LLM** models. You can either upload an image or enter some text to get started. The story will be generated using the theme you choose, you can select the theme from the sidebar.")
